...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-dark">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="\order" class="nav-link <?php echo e(Request::is('order') ? 'active' : ''); ?>">View Order</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="\cart" class="nav-link <?php echo e(Request::is('cart') ? 'active' : ''); ?>">cart</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
...
<?php /**PATH C:\Users\admin\Desktop\Shppoing\resources\views/layouts/back/master.blade.php ENDPATH**/ ?>